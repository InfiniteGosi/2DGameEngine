-- Load a different tilemap image depending on the time of the day
local current_system_hour = os.date("*t").hour

local map_texture_asset_id

if current_system_hour >= 6 and current_system_hour < 12 then
    map_texture_asset_id = "tilemap-texture-day"
elseif current_system_hour >= 12 and current_system_hour < 18 then
    map_texture_asset_id = "tilemap-texture-desert"
else 
